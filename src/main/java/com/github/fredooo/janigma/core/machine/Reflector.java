...
public class Reflector {
	...
	public static Reflector[] createM3Reflectors() {
		Reflector[] result = new Reflector[3];
		result[0] = createReflector(M3_A);
		result[1] = createReflector(M3_B);
		result[2] = createReflector(M3_C);
		return result;
	}

	public static Reflector[] buildM4ThinReflectors() {
		Reflector[] result = new Reflector[2];
		result[0] = createReflector(M4_THIN_B);
		result[1] = createReflector(M4_THIN_C);
		return result;
	}
	...
	public boolean equals(Object other) {
		...
		return otherReflector.type == this.type && otherReflector.name.equals(this.name);
	}
